...
begin
  ...
  with Lines.AddNew do
    begin
      ...
      Add.Text := 'TFatMemo by ';
      Add.FontColor := clNavy;
      Add.Text := 'Gasper Kozak (';
      Add.FontColor := clBlue;
      with Add do
        begin
          Text := AuthorEmail;
          Link := 'mailto:' + AuthorEmail;
        end;

      Add.FontColor := clNavy;
      Add.Text := ')';
      Add.FontColor := clBlack;
      Add.Text := '.';
